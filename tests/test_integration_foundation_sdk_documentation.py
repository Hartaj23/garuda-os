...
SDK_ROOT = ROOT / "docs" / "sdk" / "integration"

REQUIRED_SDK_FILES = (
    "README.md",
    "integration-sdk-guide.md",
...
class IntegrationFoundationSdkDocumentationTest(unittest.TestCase):
    ...
    def test_api_reference_documents_all_public_exports(self) -> None:
        ...
        for symbol in integration.__all__:
    ...
    def test_api_reference_contains_no_undocumented_public_symbols(self) -> None:
        ...
        public_exports = set(integration.__all__)
    ...
    def test_no_undocumented_public_exports_exist(self) -> None:
        api_reference = (SDK_ROOT / "api-reference.md").read_text(encoding="utf-8")
        documented_symbols = set(API_REFERENCE_HEADING_PATTERN.findall(api_reference))
        missing = set(integration.__all__) - documented_symbols
    ...
    def test_sdk_examples_reference_implemented_package(self) -> None:
        ...
        self.assertIn("packages.integration", practical_examples)
        self.assertIn("CanonicalIntegrationContract", practical_examples)
        self.assertIn("IntegrationRegistry", practical_examples)
        self.assertIn("evaluate_integration_artifact", practical_examples)
    ...
    def test_extension_guide_documents_constitutional_workflow(self) -> None:
        ...
        self.assertIn("Constitution (GAR-0018)", extension_guide)
